...
class AssetIconWidget extends StatelessWidget {
  ...
  static Color symbolColor(String symbol) {
    const colors = {
      ...
      'VET':   Color(0xFF15BDFF),
      'NEAR':  Color(0xFF00C08B),
      'ICP':   Color(0xFF29ABE2),
      'FIL':   Color(0xFF0090FF),
      'HBAR':  Color(0xFF222222),
      'AAVE':  Color(0xFF2EBAC6),
      'GRT':   Color(0xFF6747ED),
      // Stocks
  ...
  static const Map<String, _IconData> _localIconData = {
    ...
    'NFLX':  _IconData(Color(0xFF1A0000), Color(0xFFE50914), 'N'),
    'AMD':   _IconData(Color(0xFF1A0000), Color(0xFFED1C24), 'A'),
    'INTC':  _IconData(Color(0xFF001A33), Color(0xFF0071C5), 'i'),
    ...
    'GAS':   _IconData(Color(0xFF001A26), Color(0xFF00BFFF), 'G'),
    'COPPER':_IconData(Color(0xFF1A0D00), Color(0xFFB87333), 'Cu'),
    'EUR':   _IconData(Color(0xFF00204D), Color(0xFFFFCC00), '€'),
    'USD':   _IconData(Color(0xFF003300), Color(0xFF85BB65), '\$'),
    'GBP':   _IconData(Color(0xFF00204D), Color(0xFFFFCC00), '£'),
    'JPY':   _IconData(Color(0xFF1A0000), Color(0xFFBC002D), '¥'),
    'KAS':   _IconData(Color(0xFF00261F), Color(0xFF49EACB), 'K'),
    'XMR':   _IconData(Color(0xFF1A0D00), Color(0xFFFF6600), 'M'),
    'ATOM':  _IconData(Color(0xFF080A1A), Color(0xFF6F7390), '⚛'),
    'UNI':   _IconData(Color(0xFF1A0013), Color(0xFFFF007A), '🦄'),
    'ALGO':  _IconData(Color(0xFF000000), Color(0xFFFFFFFF), 'A'),
    'VET':   _IconData(Color(0xFF00131F), Color(0xFF15BDFF), 'V'),
    'NEAR':  _IconData(Color(0xFF001A13), Color(0xFF00C08B), 'N'),
    'ICP':   _IconData(Color(0xFF001229), Color(0xFF29ABE2), 'ICP'),
    'AAVE':  _IconData(Color(0xFF00191A), Color(0xFF2EBAC6), 'Aa'),
    'GRT':   _IconData(Color(0xFF0D0826), Color(0xFF6747ED), '◈'),
  };
}
